<div class="content-wrapper">    <!-- Content Header (Page header) -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-11">
          <div class="box">
            <form class="form-horizontal" method="post" action="<?php echo base_url('edit/edit_dokumen');?>" enctype="multipart/form-data">
          ...
          <?php foreach ($row as $data) { ?>
            <div class="form-group">
              <label class="col-md-2 control-label">Kode Dokumen</label>
                <div class="col-md-6">
                  <input type="text" class="form-control" name="kode" value="<?php echo $data['kode_dokumen'];?>">
                </div>
            </div>
            <div class="form-group">
              <label class="col-md-2 control-label">Nomor Dokumen</label>
                <div class="col-md-6">
                  <input type="text" class="form-control" name="nomor" value="<?php echo $data['nomor_dokumen'];?>">
                </div>
            </div>
            <div class="form-group">
              <label class="col-md-2 control-label">Nama Dokumen</label>
                <div class="col-md-6">
                  <input type="text" class="form-control" name="nama" value="<?php echo $data['nama_dokumen'];?>">
                </div>
            </div>
            <div class="form-group">
